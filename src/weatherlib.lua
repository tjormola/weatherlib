...
convert = {
	temperature = {
		{ -- Celcius
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round((v * 1.8) + 32, r or 1) end,
		},
		{ -- Fahrenheit
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round((v - 32) / 1.8, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
		},
	},
	speed = {
		{ -- knot
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round((v * 1.852) / 3.6, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 1.852, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round((v * 1.852) / 1.609344, r or 1) end,
		},
		{ -- m/s
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / (1.852 / 3.6), r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 3.6, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round((v * 3.6) / 1.609344, r or 1) end,
		},
		{ -- km/h
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 1.852, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 3.6, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 1.609344, r or 1) end,
		},
		{ -- mph
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round((v * 1.609344) / 1.852, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round((v * 1.609344) / 3.6, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 1.609344, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
		},
	},
	pressure = {
		{ -- hPa
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 1013.25, r or 2) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 33.8639, r or 2) end,
		},
		{ -- atm
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 1013.25, r or 2) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * (1 / 0.0334211), r or 2) end,
		},
		{ -- inHg
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 33.8639, r or 2) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 0.0334211, r or 2) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
		},
	},
	length = {
		{ -- meter
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 1000, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 0.3048, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 0.9144, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 1609.344, r or 1) end,
		},
		{ -- kilometer
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v * 1000 end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 0.0003048, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 0.0009144, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 1.609344, r or 1) end,
		},
		{ -- foot
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 0.3048, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 0.0003048, r or 2) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 3, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 5280, r or 2) end,
		},
		{ -- yard
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 0.9144, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 0.0009144, r or 2) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 3, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v / 1760, r or 2) end,
		},
		{ -- mile
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 1609.344, r) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 1.609344, r or 1) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 5280, r) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return round(v * 1760, r) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
		},
	},
	time = {
		{ -- seconds
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end local m = v % 60 v = v - m return (v / 60) + (m / 60) end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end local m = v % (60 * 60) v = v - m return (v / (60 * 60)) + (m / (60 * 60)) end,
		},
		{ -- minutes
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v * 60 end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end local m = v % 60 v = v - m return (v / 60) + (m / 60) end,
		},
		{ -- hours
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v * 60 * 60 end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v * 60 end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
		},
	},
	angle = {
		{ -- degrees
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return (math.fmod(v, 360) / 180) * math.pi end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return (math.fmod(v, 360) / 180) * 12 end,
		},
		{ -- radians
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v * 180 / math.pi end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v * 12 / math.pi end,
		},
		{ -- hours
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return (v / 12) * 180 end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return (v / 12) * math.pi end,
			function(v, r) if v == nil or type(v) ~= 'number' then return nil end return v end,
		},
	}
...
local LUNAR_INCLINATION       = convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](5.145396)
...
local function sun_ecliptic_longitude(t)
	...
	local meanAnom = convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](mean_ecliptic_longitude(ndays)
	...
	longitude = math.fmod(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](perigee_longitude(ndays))
			+ 2 * math.atan(math.sqrt((1 + e) / (1 - e)) * math.tan(eccenAnom / 2)), 2 * math.pi)
	if longitude < 0 then
...
local function ecliptic_obliquity(t)
	...
	return convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](eclip_secs / 3600)
end

local function ecl2equ(t, eclipLon, eclipLat)
	local mEclipObliq = ecliptic_obliquity(t)

	local ra = convert.angle[ANGLE_UNITS.RAD][ANGLE_UNITS.HOUR](math.atan2((math.sin (eclipLon) * math.cos (mEclipObliq) - math.tan (eclipLat) * math.sin(mEclipObliq)), math.cos (eclipLon)))
	if ra < 0 then
		ra = ra + 24
	end
...
function calc_moon(t)
	...
	--  7: eviction
	local eviction_d = 1.2739 * math.sin(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](2 * (moonLong_d - convert.angle[ANGLE_UNITS.RAD][ANGLE_UNITS.DEG](sunEclipLong_r)) - moonMeanAnom_d))
	local sinSunMeanAnom = math.sin(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](sunMeanAnom_d))
	local Ae = 0.1858 * sinSunMeanAnom
	--  8: annual equation
	local A3 = 0.37   * sinSunMeanAnom
	--  9: "third correction"
	moonMeanAnom_d = moonMeanAnom_d + eviction_d - Ae - A3
	local moonMeanAnom_r = convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](moonMeanAnom_d)
	...
	-- l''-N'
	local lN_r = convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](moonLong_d - corrLong_d)
	local lambda_r = convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](corrLong_d) + math.atan2(math.sin(lN_r) * math.cos(LUNAR_INCLINATION),  math.cos(lN_r))
	...
	local moonphase = math.fmod(15 * ra_h - convert.angle[ANGLE_UNITS.RAD][ANGLE_UNITS.DEG](sunEclipLong_r), 360)
	if moonphase < 0 then
		moonphase = moonphase + 360
	end
	local moonlatitude = convert.angle[ANGLE_UNITS.RAD][ANGLE_UNITS.DEG](decl_r)
...
local function calc_obliquity_correction(t)
	...
	local e = e0 + 0.00256 * math.cos(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](omega))
	return e		-- in degrees
end
...
local function calc_equation_of_time(t)
	...
	local y = math.tan(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](epsilon) / 2)
	y = y * y

	local sin2l0 = math.sin(2 * convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](l0))
	local sinm   = math.sin(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](m))
	local cos2l0 = math.cos(2 * convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](l0))
	local sin4l0 = math.sin(4 * convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](l0))
	local sin2m  = math.sin(2 * convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](m))

	local Etime = y * sin2l0 - 2 * e * sinm + 4 * e * y * sinm * cos2l0 - 0.5 * y * y * sin4l0 - 1.25 * e * e * sin2m
	return convert.angle[ANGLE_UNITS.RAD][ANGLE_UNITS.DEG](Etime) * 4 -- in minutes of time
end
...
local function calc_sun_equation_of_center(t)
	local m = calc_sun_geometry_mean_anomaly(t)
	local mrad = convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](m)
...
local function calc_sun_apparent_longitude(t)
	...
	local omega = 125.04 - 1934.136 * t
	local lambda = o - 0.00569 - 0.00478 * math.sin(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](omega))
...
local function calc_sun_declination(t)
	...
	local sint = math.sin(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](e)) * math.sin(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](lambda))
	local theta = convert.angle[ANGLE_UNITS.RAD][ANGLE_UNITS.DEG](math.asin(sint))
	return theta		-- in degrees
end

local function calc_sunrise_hour_angle(lat, solar_dec)
	local lat_rad = convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](lat)
	local sd_rad  = convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](solar_dec)
	local ha_arg = (math.cos(convert.angle[ANGLE_UNITS.DEG][ANGLE_UNITS.RAD](90.833)) / (math.cos(lat_rad) * math.cos(sd_rad)) - math.tan(lat_rad) * math.tan(sd_rad))
...
local function calc_sunrise_or_sunset_julian_utc(is_rise, jd, latitude, longitude)
	...
	local delta = longitude + convert.angle[ANGLE_UNITS.RAD][ANGLE_UNITS.DEG](hour_angle)
